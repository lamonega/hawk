...
PROFILE_EXAMPLE_PATH = Path(__file__).resolve().parent.parent / "config" / "profile.example.yaml"
RESUME_PATH = Path(__file__).resolve().parent.parent / "config" / "plain_text_resume.yaml"
RESUME_EXAMPLE_PATH = Path(__file__).resolve().parent.parent / "config" / "plain_text_resume.example.yaml"
